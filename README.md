...
[Start creating for free](https://tuziyo.com/ai-toolkit) · [Open Library](https://tuziyo.com/library) · [Open Studio](https://tuziyo.com/studio) · [View pricing](https://tuziyo.com/pricing)

---

## ✨ What you can do

- 🎨 **Multi-model AI generation**: Create images and videos with model-specific controls, prompt limits, duration settings, and transparent credit estimates.
...
- [MiniMax H3](https://tuziyo.com/ai/video-models/minimax-h3)
...
- Library: [tuziyo.com/library](https://tuziyo.com/library)
- Studio Lite: [tuziyo.com/studio](https://tuziyo.com/studio)
